...
export function DashBoard() {
    ...
    useEffect(() => {
        try {
            fetch(`${API_URL}pokemon/?offset=${page === 1 ? 0 : (page - 1) * itemsToShow}&limit=${itemsToShow}`)
    ...
    return (
        <div className='container'>
            <Grid container wrap justify='space-between' alignItems='center'>
                <Grid item>
                    <PaginationControlled setCurrntPage={pageHandler} itemsToShow={itemsToShow}/>
                </Grid>
